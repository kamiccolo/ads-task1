...
begin
	...
	AssertEquals('13 / 2 == 2', '6', bignum_tostring(bignum_divide(bignum_fromstring('13'), bignum_fromstring('2'))));
	...
	AssertEquals('(maxnum-1) / maxnum == 1', '0', bignum_tostring(bignum_divide(bignum_fromstring('99999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999998'), bignum_fromstring('99999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999'))));
end;
